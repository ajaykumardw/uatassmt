...
-- CreateTable
CREATE TABLE `users_additional_data` (
    `id` INTEGER NOT NULL AUTO_INCREMENT,
    `user_id` INTEGER NOT NULL,
    `employee_id` INTEGER NOT NULL,
    `job_roles` TEXT NULL,
    `job_valid_upto` TEXT NULL,
    `last_qualification` VARCHAR(191) NULL,
    `aadhaar_no` INTEGER NULL,
    `pan_card_no` VARCHAR(191) NULL,
    `educaltional_certificates` TEXT NULL,
    `assessor_certificate` TEXT NULL,
    `agreement_copy` TEXT NULL,
    `aadhaar_card` TEXT NULL,
    `pan_card` TEXT NULL,
    `cancel_check` TEXT NULL,
    `created_at` DATETIME(0) NOT NULL DEFAULT CURRENT_TIMESTAMP(0),
    `updated_at` DATETIME(0) NOT NULL DEFAULT CURRENT_TIMESTAMP(0),

    UNIQUE INDEX `users_additional_data_user_id_key`(`user_id`),
    PRIMARY KEY (`id`)
