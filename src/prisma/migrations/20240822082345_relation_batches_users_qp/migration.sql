/*
  ...
  - Added the required column `agency_id` to the `batches` table without a default value. This is not possible if the table is not empty.
...
-- AlterTable
ALTER TABLE `batches` ADD COLUMN `agency_id` INTEGER NOT NULL;
