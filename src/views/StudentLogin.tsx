...
const StudentLogin = ({ mode }: { mode: SystemMode }) => {
  // States
  ...
  const darkIllustration = '/images/illustrations/characters-with-objects/1.png'
  const lightIllustration = '/images/illustrations/characters-with-objects/1.png'
