...
const AssignedBatchesListTable = ({ tableData, updateBatchList }: { tableData?: batches[], assessorData: UsersType[], updateBatchList: () => void }) => {
    ...
    () => [
      ...
      columnHelper.accessor('action', {
        ...
        cell: ({row}) => (
          ...
          >
            {loadingId === row.original.id ? <CircularProgress size={20} color='inherit' /> : 'Unassign'}
          </Button>
        ),
        enableSorting: false
      })
...
export default AssignedBatchesListTable
