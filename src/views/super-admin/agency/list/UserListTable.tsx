...
const UserListTable = ({ tableData }: { tableData?: UsersType[] }) => {
      ...
      columnHelper.accessor('action', {
        ...
        cell: ({row}) => (
          <div className='flex items-center'>
            ...
            <IconButton>
              <Link href={getLocalizedUrl('agency/' + row.original.id, locale as Locale)} className='flex'>
  ...
  const getAvatar = (params: Pick<UsersType, 'avatar' | 'first_name' | 'last_name'>) => {
    ...
    if (avatar) {
      ...
      return <CustomAvatar size={34}>{getInitials(full_name as string)}</CustomAvatar>

      // return <CustomAvatar size={34} src={name}>{name}</CustomAvatar>
    }
  }
  ...
  return (
    <>
      <Card>
        ...
        <div className='flex justify-between flex-col items-start md:flex-row md:items-center p-6 border-bs gap-4'>
          ...
          <div className='flex flex-col sm:flex-row is-full sm:is-auto items-start sm:items-center gap-4'>
            ...
            <Link href={getLocalizedUrl('agency/create', locale as Locale)} className='flex'>
              <Button
                variant='contained'
      ...
      {/* <DialogEditUserInfo setOpen={setOpen} open={true} /> */}
    </>
  )
}
