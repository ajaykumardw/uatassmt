...
const PracticalExamSetsListTable = ({ tableData, updateExamSetsList }: { tableData?: exam_sets[], updateExamSetsList: () => void }) => {
  ...
  return (
    <>
      ...
      <AddEditPracticalExamSetsDialog open={addQuestionOpen} updateExamSetsList={updateExamSetsList} handleClose={() => setAddQuestionOpen(!addQuestionOpen)} />
      <AddEditPracticalExamSetsDialog open={editQuestionOpen} examSetId={examSetId} updateExamSetsList={updateExamSetsList} handleClose={() => setEditQuestionOpen(!editQuestionOpen)} />
    </>
  )
}

export default PracticalExamSetsListTable
