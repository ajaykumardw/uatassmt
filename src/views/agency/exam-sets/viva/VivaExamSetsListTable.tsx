...
import AddEditVivaExamSetsDialog from '@/components/exam-sets/dialogs/AddEditVivaExamSetsDialog';
...
const VivaExamSetsListTable = ({ tableData, updateExamSetsList }: { tableData?: exam_sets[], updateExamSetsList: () => void }) => {
  ...
  return (
    <>
      ...
      <AddEditVivaExamSetsDialog open={addQuestionOpen} updateExamSetsList={updateExamSetsList} handleClose={() => setAddQuestionOpen(!addQuestionOpen)} />
      <AddEditVivaExamSetsDialog open={editQuestionOpen} examSetId={examSetId} updateExamSetsList={updateExamSetsList} handleClose={() => setEditQuestionOpen(!editQuestionOpen)} />
    </>
  )
}

export default VivaExamSetsListTable
