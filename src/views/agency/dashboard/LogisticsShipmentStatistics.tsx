...
const series = [
  {
    name: 'Enrolled',
    type: 'column',
    data: [743, 1000, 800, 600, 700, 990, 780, 800, 553, 150, 0, 0]
  },
  {
    name: 'Assessment',
    type: 'line',
    data: [642, 857, 404, 424, 479, 912, 554, 349, 152, 32, 0, 0]
  }
]
...
const LogisticsShipmentStatistics = () => {
  ...
  return (
    <Card>
      <CardHeader title='Month Wise Assessments' subheader='Current Year' action={<MonthButton />} />
      <CardContent>
        <AppReactApexCharts
