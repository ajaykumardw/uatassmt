...
import { GenderMap, MenuProps, STUDENT_RESULT, STUDENT_RESULT_LABEL, TableRowLimit } from '@/configs/customDataConfig'
        ...
        cell: ({ row }) => (
          <Typography color='text.primary' className='font-medium'>
            {row.original.result == null ? (
              ...
              <Chip label={STUDENT_RESULT_LABEL[row.original.result]} color={row.original.result === STUDENT_RESULT.PASS ? 'success' : 'error'} className='capitalize' />
            )}
          </Typography>
        )
      }),
