...
const PracticalQuestionsListTable = ({ tableData, updateQuestionsList }: { tableData?: questions[], updateQuestionsList: () => void }) => {
  ...
  return (
    <>
      ...
      <AddEditPracticalQuestionsDialog open={addQuestionOpen} updateQuestionsList={updateQuestionsList} handleClose={() => setAddQuestionOpen(!addQuestionOpen)} />
...
export default PracticalQuestionsListTable
