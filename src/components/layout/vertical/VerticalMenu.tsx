    ...
    >
      ...
      >
        ...
        <SubMenu label={dictionary['navigation'].batches} icon={<i className='tabler-stack-2' />}>
          ...
          <MenuItem href={`/${locale}/batches/pending`}>{dictionary['navigation'].pending}</MenuItem>
          <MenuItem href={`/${locale}/batches/completed`}>{dictionary['navigation'].completed}</MenuItem>
        </SubMenu>
        ...
        <MenuItem href={`/${locale}/languages`} icon={<i className='tabler-language' />}>
        ...
        <SubMenu label="Invoice" icon={<i className='tabler-file-invoice' />}>
          <MenuItem href={`/${locale}/invoice/master`}>Invoice Master</MenuItem>
          <MenuItem href={`/${locale}/invoice/ssc`} disabled>SSC Invoice</MenuItem>
          <MenuItem href={`/${locale}/invoice/assessor`} disabled>Assessor Invoice</MenuItem>
          <MenuItem href={`/${locale}/invoice/tp`} disabled>TP Invoice</MenuItem>
        </SubMenu>
        <SubMenu label={dictionary['navigation'].reports} icon={<i className='tabler-report' />}>
          ...
          <MenuItem href={`/${locale}/reports/candidate-result`}>Candidate wise Report</MenuItem>
          <MenuItem href={`/${locale}/reports/miscellaneous-reports`}>Miscellaneous Reports</MenuItem>
        </SubMenu>
        <SubMenu label="Analysis" icon={<i className='tabler-report' />}>
          <MenuItem href={`/${locale}/analysis/assessor-wise-result`}>Assessor wise Result %</MenuItem>
          <MenuItem href={`/${locale}/analysis/batch-wise-result`}>Batch wise Result %</MenuItem>
          <MenuItem href={`/${locale}/analysis/ssc-wise-result`}>SSC wise Result %</MenuItem>
          <MenuItem href={`/${locale}/analysis/assessor-rating`} disabled>Assessor Rating</MenuItem>
        </SubMenu>
        ...
        <SubMenu label="Certificate Templates" icon={<i className='tabler-certificate' />}>
          <MenuItem href={`/${locale}/certificate-templates`}>List</MenuItem>
          <MenuItem href={`/${locale}/certificate-templates/create`}>Create</MenuItem>
        </SubMenu>
