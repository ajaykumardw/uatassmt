  ...
  return (
    ...
    >
      ...
      >
        ...
        <MenuItem href={`/${locale}/assessor/training-resource`} icon={<i className='tabler-git-merge' />}>Training Resources</MenuItem>
        <MenuItem href={`/${locale}/assessor/invoices`} icon={<i className='tabler-file-description' />}>Invoices</MenuItem>
