...
const Page = () => {
  ...
  const downloadSample = async () => {
    ...
    // headers
    sheet.addRow(["batch_name", "date"]);

    // sample rows
    sheet.addRow(["Batch 1", "01-01-2026"]);
    sheet.addRow(["Batch 2", "15-01-2026"]);
    ...
    a.href = url;
    a.download = "batch-date-correction-sample.xlsx";
    a.click();
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      const res = await fetch("/api/batches/auto-update", {
        method: "POST",
        body: formData
      });
  ...
  return (
    <div className="p-4">
      <h1 className="text-2xl font-bold mb-4">Batch Date Correction</h1>

      <p className="mb-2">
        Upload an Excel file and confirm your password to update batch dates.
      </p>
              ...
              <Table size="small">
                <TableHead>
                  <TableRow>
                    ...
                    <TableCell><b>Actual Date</b></TableCell>
