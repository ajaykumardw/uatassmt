...
import BatchesChart from '@/views/agency/dashboard/Batches'



const MonitoringTeamDashboard = async () => {

  // const session = await getServerSession(authOptions);

  const batches = await prisma.sector_skill_councils.findUnique({
    where: {
      id: 3
    },
    select: {
  ...
  return (
    <Grid container spacing={6}>
      ...
      <Grid item xs={12} lg={6}>
        <BatchesChart />
        {/* <AssessorReports serverMode={serverMode} data={batches} /> */}
      </Grid>
